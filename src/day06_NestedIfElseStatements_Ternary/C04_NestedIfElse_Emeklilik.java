    ...
    public static void main(String[] args) {
        ...
        if (cinsiyet == 'K') {
            ...
            if (yas < 20 || yas > 80) {
                ...
                System.out.println("60 yasindan buyuk bir kadin oldugunuz icin emekli olabilirsiniz");
            } else {
            ...
            if (yas < 20 || yas > 80) {
                ...
                System.out.println("65 yasindan buyuk bir erkek oldugunuz icin emekli olabilirsiniz");
            } else {
